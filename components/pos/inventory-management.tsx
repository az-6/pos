...
import { usePOS, InventoryItem, IncomingGood } from "./pos-context-firebase";
                ...
                {lowStockItems.map((item) => (
                  ...
                  >
                    ...
                    <AlertDescription className="text-orange-900">
                      <strong>{item.name}</strong> - Stok: {item.quantity} (min:{" "}
                      {item.minStock})
                    </AlertDescription>
                  </Alert>
                ))}
                    ...
                    .map((good) => {
                      ...
                      return (
                        <TableRow key={good.id}>
                          ...
                          <TableCell>
                            {new Date(good.expiryDate).toLocaleDateString(
                              "id-ID",
                            )}
                          </TableCell>
                          <TableCell>

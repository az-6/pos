...
export default function CashierInterface() {
  const { cart, inventory, addToCart, removeFromCart, updateCartQuantity, completeTransaction, addInventoryItem } = usePOS()
            ...
            {showNewItem && (
              <div className="space-y-3 p-3 border rounded-lg bg-muted/50">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewItemData({ ...newItemData, price: parseFloat(e.target.value) })
                  }
                />
                <Input
                  type="number"
                  ...
                  onChange={(e) =>
                    setNewItemData({ ...newItemData, cost: parseFloat(e.target.value) })
                  }
                />
